...
import com.example.spending_management_app.service.ExpenseService;
                                ...
                                if (!allJsonParts.isEmpty()) {
                                    ...
                                    for (String jsonPart : allJsonParts) {
                                        try {
                                            ...
                                            ExpenseService.saveExpenseDirectly(jsonPart, activity, messages, chatAdapter, messagesRecycler);
                                        } catch (Exception e) {
